...
export interface CountryFeature {
  ...
  region: string;
  polygons: number[][][];
  feature?: any; // The original GeoJSON feature for three-globe
}

const NAMES: Record<string, [string, string]> = {
  "004": ["Afghanistan", "South Asia"], "008": ["Albania", "Southern Europe"], "010": ["Antarctica", "Antarctica"],
  ...
  "092": ["British Virgin Islands", "Caribbean"], "096": ["Brunei", "Southeast Asia"],
  "100": ["Bulgaria", "Eastern Europe"], "104": ["Myanmar", "Southeast Asia"], "108": ["Burundi", "East Africa"],
  "112": ["Belarus", "Eastern Europe"], "116": ["Cambodia", "Southeast Asia"], "120": ["Cameroon", "Central Africa"],
  "124": ["Canada", "North America"], "132": ["Cape Verde", "West Africa"], "140": ["Central African Republic", "Central Africa"],
  "144": ["Sri Lanka", "South Asia"], "148": ["Chad", "Central Africa"], "152": ["Chile", "South America"],
  "156": ["China", "East Asia"], "158": ["Taiwan", "East Asia"], "170": ["Colombia", "South America"],
  "174": ["Comoros", "East Africa"], "178": ["Congo", "Central Africa"], "180": ["Dem. Rep. Congo", "Central Africa"],
  ...
  "218": ["Ecuador", "South America"], "222": ["El Salvador", "Central America"], "226": ["Equatorial Guinea", "Central Africa"],
  "231": ["Ethiopia", "East Africa"], "232": ["Eritrea", "East Africa"], "233": ["Estonia", "Northern Europe"],
  ...
  "578": ["Norway", "Northern Europe"], "583": ["Micronesia", "Oceania"], "585": ["Palau", "Oceania"],
  "586": ["Pakistan", "South Asia"], "591": ["Panama", "Central America"], "598": ["Papua New Guinea", "Oceania"],
  "600": ["Paraguay", "South America"], "604": ["Peru", "South America"], "608": ["Philippines", "Southeast Asia"],
  "616": ["Poland", "Eastern Europe"], "620": ["Portugal", "Southern Europe"], "624": ["Guinea-Bissau", "West Africa"],
  "626": ["Timor-Leste", "Southeast Asia"], "630": ["Puerto Rico", "Caribbean"], "634": ["Qatar", "Western Asia"],
  "642": ["Romania", "Eastern Europe"], "643": ["Russia", "Eastern Europe"], "646": ["Rwanda", "East Africa"],
  ...
  "776": ["Tonga", "Oceania"], "780": ["Trinidad and Tobago", "Caribbean"], "784": ["United Arab Emirates", "Western Asia"],
  "788": ["Tunisia", "North Africa"], "792": ["Turkey", "Western Asia"], "795": ["Turkmenistan", "Central Asia"],
  "798": ["Tuvalu", "Oceania"], "800": ["Uganda", "East Africa"], "804": ["Ukraine", "Eastern Europe"],
  ...
  "876": ["Wallis and Futuna", "Oceania"], "882": ["Samoa", "Oceania"], "887": ["Yemen", "Western Asia"],
  "894": ["Zambia", "East Africa"], "-99": ["N. Cyprus", "Western Asia"], "733": ["Falkland Islands", "South America"],
  ...
  "654": ["St. Helena", "West Africa"], "660": ["Anguilla", "Caribbean"], "666": ["St. Pierre and Miquelon", "North America"],
  "698": ["Sint Maarten", "Caribbean"], "772": ["Tokelau", "Oceania"],
  "796": ["Turks and Caicos", "Caribbean"], "831": ["Guernsey", "Northern Europe"],
  "832": ["Jersey", "Northern Europe"], "833": ["Isle of Man", "Northern Europe"],
};

export function computeCountryCenter(country: CountryFeature): { lat: number; lng: number } | null {
  let totalLng = 0;
  let totalLat = 0;
  let count = 0;
...
export async function fetchCountries(): Promise<CountryFeature[]> {
  ...
  const geo = topojson.feature(topology, topology.objects.countries) as FeatureCollection;

  cache = geo.features
    .filter((f) => f.id !== undefined)
    .map((f) => {
      const id = String(f.id);
      const [name, region] = NAMES[id] || [`Country ${id}`, "Unknown"];
      ...
      return { id, name, region, polygons, feature: f };
    })
