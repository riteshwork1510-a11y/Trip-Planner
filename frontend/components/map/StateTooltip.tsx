...
interface StateTooltipProps {
  stateFeature: any | null;
  countryName: string;
  position: { x: number; y: number } | null;
}

export default function StateTooltip({ stateFeature, countryName, position }: StateTooltipProps) {
          ...
          <div className="bg-[#0a1f2e]/90 backdrop-blur-xl border border-white/[0.12] rounded-xl px-4 py-3 shadow-2xl min-w-[200px]">
            <div className="mb-2">
              <p className="text-white/95 text-sm font-semibold leading-tight">
                {stateFeature.properties?.name || "Unknown State"}
              </p>
            ...
            <div className="border-t border-white/[0.08] pt-2 mt-2">
              <div className="flex justify-between items-center text-xs mb-1">
                ...
                <span className="text-white/80 font-medium">N/A</span>
              </div>
              <div className="flex justify-between items-center text-xs mb-1">
